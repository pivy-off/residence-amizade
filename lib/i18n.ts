...
export const translations = {
  fr: {
    ...
    reviews: {
      ...
      leaveReviewText: 'Partagez votre expérience sur Google. Votre avis nous aide à améliorer nos services.',
  ...
  en: {
    ...
    reviews: {
      ...
      leaveReviewText: 'Share your experience on Google. Your review helps us improve our services.',
